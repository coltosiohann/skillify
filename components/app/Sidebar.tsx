  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-20 w-6 h-6 rounded-full bg-white border border-primary/15 shadow-sm flex items-center justify-center hover:bg-primary/5 transition-colors cursor-pointer z-10"
