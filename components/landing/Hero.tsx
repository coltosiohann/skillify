...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-16">
      ...
      <div className="absolute bottom-20 right-1/4 w-80 h-80 bg-indigo-300/15 rounded-full blur-3xl pointer-events-none" />
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <svg className="absolute -bottom-1 left-0 w-full" height="6" viewBox="0 0 100 6" fill="none" preserveAspectRatio="none">
                <path d="M0 5 Q50 0 100 5" stroke="#5B4CF5" strokeWidth="2.5" strokeLinecap="round" fill="none" opacity="0.5" />
              </svg>
            </span>
          </motion.h1>
...
function PhoneFrame({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative rounded-[2.5rem] bg-[#1E293B] p-1.5 shadow-2xl shadow-primary/20 border border-white/10">
      {/* Notch */}
...
function ProgressCard() {
  return (
    <div className="w-full h-full bg-gradient-to-b from-[#4338CA] via-[#5B4CF5] to-[#818CF8] p-4 pt-8 flex flex-col gap-3">
...
function GeneratingCard() {
  return (
    <div className="w-full h-full bg-gradient-to-br from-[#EEF2FF] to-[#E0E7FF] p-4 pt-8 flex flex-col items-center justify-center gap-4">
